...
module.exports.OUTPUT = '[name].js'

module.exports.BODY_TAG = '</body>'

module.exports.POLYFILL_CODE = `import 'core-js/stable'
import 'regenerator-runtime/runtime'`

module.exports.EXCLUDE_MODULES = ['core-js/stable', 'regenerator-runtime/runtime', 'prop-types']

module.exports.FILE_TAG = '__falco__'
